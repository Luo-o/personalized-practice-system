...
export default function ProfilePage() {
  ...
  const profile = useMemo(() => {
    ...
    return {
      studentNo: raw.student_no || raw.studentNo || "",
      name: raw.name || "",
      gender: raw.gender || "",
      phone: raw.phone || "",
      email: raw.email || "",
  ...
  const accountDisplay = useMemo(() => {
    return {
      studentNo: profile.studentNo || "未设置",
  ...
  return (
    <div className="profile-page-v2">
      <div className="profile-page-v2__container profile-page-v2__container--list">
        <div className="profile-page-v2__hero">
          <div className="profile-page-v2__avatar-wrap">
            <img
              className="profile-page-v2__avatar"
              src={profile.avatar}
              alt="学生头像"
            />
          </div>

          <div className="profile-page-v2__hero-info">
            <div className="profile-page-v2__hero-name">
              {profile.name || "未设置姓名"}
            </div>
            <div className="profile-page-v2__hero-meta">
              {[
                profile.major || "未设置专业",
                profile.grade || "未设置年级",
              ].join(" · ")}
        ...
        <SettingSection
          title="账号信息"
          subtitle="你可以使用学号、邮箱或手机号码登录"
        >
          <SettingItem
            icon={<ContainerFilled />}
            label="学号"
            value={accountDisplay.studentNo}
            onClick={() =>
              Modal.info({
                title: "学号",
                content: "学号为系统字段，不支持自行修改。",
                okText: "我知道了",
                centered: true,
              })
            }
      ...
      >
        <div className="profile-modal-body">
          ...
          <div className="profile-avatar-picker">
            {STUDENT_AVATAR_OPTIONS.map((item) => {
